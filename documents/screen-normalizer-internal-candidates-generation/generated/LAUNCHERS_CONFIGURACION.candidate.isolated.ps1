...
function Header {
  Clear-Host
  Line '==== LAUNCHERS / CONFIGURACION ====' 'Cyan'
  Line 'Ruta: INICIO > Launchers / Configuracion' 'DarkGray'
  Line 'Rol: Revisar launchers, configuracion local y rutas de entrada.' 'DarkGray'
...
function Help {
  Header
  Line "AYUDA" "Cyan"
  Line 'Que hace: Permite auditar accesos, configuraciones y piezas de arranque del operador.' 'Gray'
  Line ""
...
function Maintenance {
  ...
  Line 'screen_id=LAUNCHERS_CONFIGURACION' 'Gray'
...
function Main {
  while($true){
    Header
    Line "PANTALLA" "Cyan"
    Line 'Permite auditar accesos, configuraciones y piezas de arranque del operador.' 'Gray'
    Line ""
    Line "COMANDOS" "Cyan"
