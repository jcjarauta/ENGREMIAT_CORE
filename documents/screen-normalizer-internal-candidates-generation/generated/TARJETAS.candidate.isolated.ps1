...
function Header {
  Clear-Host
  Line '==== TARJETAS ====' 'Cyan'
  Line 'Ruta: INICIO > Tarjetas' 'DarkGray'
  Line 'Rol: Consultar tarjetas, acciones, gates y flujo modular.' 'DarkGray'
...
function Help {
  Header
  Line "AYUDA" "Cyan"
  Line 'Que hace: Muestra tarjetas operativas, acciones disponibles y gates humanos.' 'Gray'
  Line ""
...
function Main {
  while($true){
    Header
    Line "PANTALLA" "Cyan"
    Line 'Muestra tarjetas operativas, acciones disponibles y gates humanos.' 'Gray'
    Line ""
    Line "COMANDOS" "Cyan"
