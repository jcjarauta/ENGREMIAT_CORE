...
function Header {
  Clear-Host
  Line '==== OPERADOR / WORKERS ====' 'Cyan'
  Line 'Ruta: INICIO > Operador / Workers' 'DarkGray'
  Line 'Rol: Supervisar operador, workers y ejecuciones controladas.' 'DarkGray'
...
function Help {
  Header
  Line "AYUDA" "Cyan"
  Line 'Que hace: Agrupa estado de workers, colas, ejecuciones y limites de seguridad.' 'Gray'
  Line ""
...
function Maintenance {
  ...
  Line 'screen_id=OPERADOR_WORKERS' 'Gray'
...
function Main {
  while($true){
    Header
    Line "PANTALLA" "Cyan"
    Line 'Agrupa estado de workers, colas, ejecuciones y limites de seguridad.' 'Gray'
    Line ""
    Line "COMANDOS" "Cyan"
