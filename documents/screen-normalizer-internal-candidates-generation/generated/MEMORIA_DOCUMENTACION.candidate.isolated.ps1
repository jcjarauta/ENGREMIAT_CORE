...
function Header {
  Clear-Host
  Line '==== MEMORIA / DOCUMENTACION ====' 'Cyan'
  Line 'Ruta: INICIO > Memoria / Documentacion' 'DarkGray'
  Line 'Rol: Consultar memoria, documentacion, evidencias y continuidad del sistema.' 'DarkGray'
...
function Help {
  Header
  Line "AYUDA" "Cyan"
  Line 'Que hace: Centraliza acceso a documentos, memoria operativa, evidencias y contexto.' 'Gray'
  Line ""
...
function Maintenance {
  ...
  Line 'screen_id=MEMORIA_DOCUMENTACION' 'Gray'
...
function Main {
  while($true){
    Header
    Line "PANTALLA" "Cyan"
    Line 'Centraliza acceso a documentos, memoria operativa, evidencias y contexto.' 'Gray'
    Line ""
    Line "COMANDOS" "Cyan"
