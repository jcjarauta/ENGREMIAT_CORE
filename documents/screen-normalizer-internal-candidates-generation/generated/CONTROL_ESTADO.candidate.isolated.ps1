...
function Header {
  Clear-Host
  Line '==== CONTROL / ESTADO ====' 'Cyan'
  Line 'Ruta: INICIO > Control / Estado' 'DarkGray'
  Line 'Rol: Consultar estado compacto, salud del sistema y senales operativas.' 'DarkGray'
...
function Help {
  Header
  Line "AYUDA" "Cyan"
  Line 'Que hace: Muestra estado operativo, readiness, bloqueos y siguiente paso recomendado.' 'Gray'
  Line ""
...
function Maintenance {
  ...
  Line 'screen_id=CONTROL_ESTADO' 'Gray'
...
function Main {
  while($true){
    Header
    Line "PANTALLA" "Cyan"
    Line 'Muestra estado operativo, readiness, bloqueos y siguiente paso recomendado.' 'Gray'
    Line ""
    Line "COMANDOS" "Cyan"
