# E05B audit m route order command not recognized no apply

## Decision
WARN_M_ROUTE_PRESENT_ORDER_NEEDS_MANUAL_CONTEXT_REPAIR

## Human observation
En INICIO aparece `m = mantenimiento`, pero al pulsar m devuelve comando no reconocido.
...
## Lines
- read_hosts: 
29, 31, 32, 33, 34, 35, 38, 39, 40, 41, 43
- m_routes: 
1, 30, 36, 37, 42
- unknown_handlers: 
32, 35
...
## Contexts
## ReadHost / m / unknown / router contexts
### around line 1
...
## Next
E05C_PREPARE_M_ROUTE_BEFORE_UNKNOWN_HANDLER_NO_APPLY
