# E05H router map INICIO readhost context no apply

Decision: ROUTER_MAP_READY_NO_APPLY
Parse OK: 
True
Inicio: 
...
## Lectura
Buscar el Read-Host que esté justo después de la pantalla INICIO real, no los Read-Host del formulario de tarjeta: sev/exp/obs/act.
...
## Next
E05I_SELECT_REAL_INICIO_ROUTER_ANCHOR_AND_PREPARE_PATCH_NO_APPLY
