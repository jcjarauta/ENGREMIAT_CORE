# GROUP - tools\launcher  Count: 31 Classes: CODE_REVIEW:26, DOCS_REPORTS_REVIEW:1, UNTRACKED_REVIEW:4 Recommended action: INSPECT_DIFF_BEFORE_SCOPED_COMMIT Apply changes: NO Delete files: NO Commit: NO Push: NO  ```text
