# E10 Global Scope After Reports Launcher Reconcile No Apply
...
## Global by class
- DOCS_REPORTS_REVIEW: 125
- CODE_REVIEW: 50
- NOISE_OR_GENERATED: 28
- OPERATOR_V2_SCOPED_REVIEW: 17
- UNTRACKED_REVIEW: 15

## reports\launcher pendiente
- Total: 32
- NOISE_OR_GENERATED: 27
- DOCS_REPORTS_REVIEW: 5

## reports\launcher CODE_REVIEW
```text
```

## reports\launcher NOISE_OR_GENERATED
```text
...
## reports\launcher DOCS_REPORTS_REVIEW
```text
...
## Decision
PREPARE_NOISE_REVIEW_NO_DELETE

## Siguiente
E11_PREPARE_REPORTS_LAUNCHER_NOISE_REVIEW_NO_DELETE
