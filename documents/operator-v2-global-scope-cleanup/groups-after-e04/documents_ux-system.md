# GROUP AFTER E04 - documents\ux-system  Count: 33 Classes: DOCS_REPORTS_REVIEW:33 Recommended action: CANDIDATE_SCOPED_DOCS_REPORTS_COMMIT_BY_PACKAGE Apply changes: NO Delete files: NO Commit: NO Push: NO  ```text
