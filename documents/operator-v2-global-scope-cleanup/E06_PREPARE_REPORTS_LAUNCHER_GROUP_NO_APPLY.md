# E06 Prepare Reports Launcher Group No Apply
...
- Paths unique: 
151
- All DOCS_REPORTS_REVIEW: 
False

## Decision
MIXED_GROUP_REVIEW_REQUIRED_NO_COMMIT

## Recommendation
DO_NOT_COMMIT_GROUP_UNTIL_SPLIT_BY_CLASS

## Authorization required if commit desired
AUTORIZO_COMMIT_SCOPED_REPORTS_LAUNCHER_SIN_ADD_DOT_SIN_PUSH
...
## Siguiente
E07_EXECUTE_AUTHORIZED_REPORTS_LAUNCHER_SCOPED_COMMIT_NO_PUSH
