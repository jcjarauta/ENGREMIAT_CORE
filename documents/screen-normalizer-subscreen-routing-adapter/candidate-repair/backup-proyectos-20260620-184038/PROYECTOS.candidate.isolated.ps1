...
$Screen = '{"screen_id":"PROYECTOS","parent":"INICIO","title":"PROYECTOS","route":"INICIO \u003e Proyectos","role":"cartera de proyectos, modulos y tarjetas vinculadas","description":"Permite seleccionar proyectos, revisar historicos y navegar hacia modulos/tarjetas.","status":"PENDING_MIGRATION","principle":"PROYECTO \u003e MODULO \u003e TARJETA | readonly por defecto | workers seguros","prompt":"PROYECTOS","source":"tools\\launcher\\ENGREMIAT-PROJECTS-CENTER-NORMALIZED.ps1","risk":"LOW","requires_human_gate":false,"commands":["b = volver","m = mantenimiento","? = ayuda","Enter = refrescar"],"actions":[]}' | ConvertFrom-Json
$ScreenHash = @{}
