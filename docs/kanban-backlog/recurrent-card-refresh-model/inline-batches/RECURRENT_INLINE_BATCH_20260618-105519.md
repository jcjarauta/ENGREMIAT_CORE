...
Decision esperada:
PASS solo si el lote contiene 2 tarjetas recurrentes listas para revision humana.

| Card | Source | Kind | Priority | Risk | Title |
|---|---|---|---:|---|---|
| ENG-CARD-RECURRENT-20260618-105519-0001 | openclaw | project | 76 | LOW | Entrada real-readonly preparada para ENGREMIAT |
| ENG-CARD-RECURRENT-20260618-105519-0002 | openclaw | project | 80 | LOW | Convertir conversación OpenWebUI en tarjeta ENGREMIAT |
